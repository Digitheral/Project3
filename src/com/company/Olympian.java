...
public class Olympian extends OlympianManager
{
    ...
    protected static Sex[] sex = {Sex.MALE, Sex.MALE, Sex.MALE, Sex.MALE, Sex.FEMALE, Sex.FEMALE, Sex.FEMALE, Sex.MALE, Sex.MALE, Sex.MALE, Sex.MALE, Sex.MALE,Sex.FEMALE, Sex.MALE};
